...
PIPELINE_PARAMS=(
        "--sample" "${SAMPLE_ID}"
        "--outdir" "/scratch/pawsey1132/atims/curationpretext/${BRANCH}/results"
        "--input" "/scratch/pawsey1132/atims/curationpretext/${BRANCH}/scaffolds/both_haps_scaffolds_final.fa"
        "--reads" "/scratch/pawsey1132/atims/curationpretext/${BRANCH}/hifi/"
        "--cram" "/scratch/pawsey1132/atims/curationpretext/${BRANCH}/hic/"
        "--teloseq" "TTAGGG"
        "--aligner" "bwamem2"
        "--all_output" "true"
        "--skip_tracks" "NONE"
